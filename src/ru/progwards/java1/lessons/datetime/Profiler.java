...
public class Profiler {
    public static LinkedList<StatisticInfo> statisticInfos = new LinkedList<>();

    public static ArrayDeque<StatisticInfo> stack = new ArrayDeque<>();
    ...
    public static StatisticInfo createStatisticInfo(String name) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(statisticInfos);
